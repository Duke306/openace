 ...
 */
class LR2021 : public Radio, public etl::message_router<LR2021, GATAS::RadioTxFrameMsg, GATAS::ConfigUpdatedMsg, GATAS::GpsStatsMsg, GATAS::RadioControlMsg>
{
    ...
    static constexpr lr20xx_pa_cfg_params_s DEFAULT_HIGH_POWER_PA_CFG =
        {
    ...
    static constexpr lr20xx_pa_cfg_params_s DEFAULT_LOW_POWER_PA_CFG =
        {
    ...
    static constexpr lr20xx_pkt_params_gfsk_t DEFAULT_PKG_PARAMS_GFSK =
        {
    ...
    static constexpr lr20xx_mod_params_gfsk_t DEFAULT_MOD_PARAMS_GFSK =
        {
    ...
    static constexpr lr20xx_cad_params_t DEFAULT_CAD_PARAMS =
        {
    ...
    // 13.67
    static constexpr lr20xx_pkt_params_lora_t DEFAULT_PKG_PARAMS_LORA =
        {
    ...
    static constexpr lr20xx_mod_params_lora_t DEFAULT_MOD_PARAMS_LORA =
        {
            .sf = SX126X_LORA_SF7,
    ...
    lr20xx_errors_mask_t lastDeviceError=0;
    lr20xx_errors_mask_t currentDeviceError=0;
...
public:
    ...
    LR2021(etl::imessage_bus &bus, const GATAS::PinTypeMap &pins, uint8_t radioNo_, bool txEnabled_, bool groundStation_, uint32_t offsetHz_) : Radio(bus, Radio::NAMES[radioNo_]),
    ...
    LR2021(etl::imessage_bus &bus, const Configuration &config, uint8_t radioNo_) : LR2021(bus,
    ...
    void configureLR2021(const GATAS::RadioParameters &newParameters, uint8_t txPayloadLength);
    lr20xx_irq_mask_t getIrqStatus();
    bool isTxDone();
